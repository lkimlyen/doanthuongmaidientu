...
namespace webanhnguyen.Controllers
{
    public class PayPalController : Controller
    {
        ...
        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            {
                currency = "USD",
                total = "8", // Total must be equal to sum of shipping, tax and subtotal.
                details = details
            };
            ...
            Random r = new Random();
            string maHoaDon = r.Next(111111,999999).ToString();
            //Tất cả thông tin thanh toán cần đưa vào transaction
            transactionList.Add(new Transaction()
            {
                description = "Transaction description.",
                invoice_number = maHoaDon,
                amount = amount,
                item_list = itemList
            });
